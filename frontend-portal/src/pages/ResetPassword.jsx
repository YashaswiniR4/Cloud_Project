...
import { Lock, Mail, KeyRound, ArrowRight, AlertCircle, CheckCircle2, Loader2, Check, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#070a11] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl border border-slate-800 shadow-2xl relative z-10 space-y-5">
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-white tracking-wide">Reset Account Password</h1>
            <p className="text-xs text-slate-400 mt-1">
              Enter your registered email, the 6-digit OTP code received, and your new password.
            </p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="user@sentinelai.com"
