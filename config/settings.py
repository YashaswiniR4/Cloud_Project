...
class Settings:
    ...
    JWT_SECRET_KEY: str = os.getenv("JWT_SECRET_KEY", "soc_super_secret_jwt_key_2026_cloud_threat_intel")
    ...
    SMTP_USE_SSL: bool = os.getenv("SMTP_USE_SSL", "false").lower() in ("true", "1", "t")
